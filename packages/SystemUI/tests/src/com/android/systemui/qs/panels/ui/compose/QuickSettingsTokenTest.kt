...
class QuickSettingsTokenTest : SysuiTestCase() {
    ...
    fun compactChrome_usesFoundationGeometry() {
        ...
        assertThat(dimensionDp(R.dimen.overlay_qs_layout_brightness_track_line_height))
            .isEqualTo(4f)
        assertThat(dimensionDp(R.dimen.overlay_qs_layout_brightness_thumb_height)).isEqualTo(20f)
        assertThat(dimensionDp(R.dimen.overlay_qs_layout_brightness_thumb_width)).isEqualTo(20f)
        assertThat(dimensionDp(R.dimen.overlay_qs_layout_brightness_vertical_padding)).isEqualTo(0f)
        ...
        assertThat(dimensionDp(R.dimen.overlay_qs_layout_brightness_track_height))
            .isGreaterThan(dimensionDp(R.dimen.overlay_qs_layout_brightness_thumb_height))
    ...
    fun fluentColors_useFixedAccessibleWindowsRoles() {
        ...
        assertThat(Color.alpha(color(R.color.fluent_qs_panel_tint_light))).isLessThan(255)
        assertThat(Color.alpha(color(R.color.fluent_qs_panel_tint_dark))).isLessThan(255)
